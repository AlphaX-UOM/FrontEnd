...
function Displayratings(props) {
    ...
    useEffect(() => {
        fetch(
            `https://alphax-api.azurewebsites.net/api/tourguideServiceRatings` //`https://alphax-api.azurewebsites.net/api/eventplannerservicereservations/${userId}`
        )
            ...
            .then((responseData) => {
                ...
                responseData = responseData.filter(item => item.tourGuideServiceID === props.id);
