          ...
          <Row>
            ...
            <Col xs={5}>
              <div>
                ...
                <button type="button" class="btn btn-warning" onClick={ add_to_cart(props.data.name,props.data.price,props.data.id,quantity,date,"EventService",props.data.price*quantity,quantity,null,null,null,null,null,null)}>
                  {/*<AddShoppingCartIcon />*/}
                  Add to Cart
                </button>
                </Link>
