      ...
      <div>
        <CardDeck>
          <ResultComponent
            ...
            price={
              eventList[props.idss - 1].price * travellers +
              eventList[props.idss].price * travellers +
              transportList[props.idss - 1].pricePerDay +
              tourguideList[props.idss - 1].costPerDay * days +
              hotelList[props.idss - 1].pricePerDay * days * hotelcouple
            }
          ...
          <ResultComponent
            ...
            price={
              eventList[props.idss].price * travellers +
              eventList[props.idss + 1].price * travellers +
              transportList[props.idss].pricePerDay +
              tourguideList[props.idss].costPerDay * days +
              hotelList[props.idss].pricePerDay * days * hotelcouple
            }
            travellers={travellers}
            budget={budget}
            days={days}
