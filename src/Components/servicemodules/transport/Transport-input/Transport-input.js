...
const mapDispatchToProps = (dispatch) => {
    return {
        transport_input_form:  (no_travellers,drop_location,drop_date,drop_time,pickup_location,pickup_date,pickup_time,rounded,distance_text) => { dispatch(actions.get_transport_input_form(no_travellers,drop_location,drop_date,drop_time,pickup_location,pickup_date,pickup_time,rounded,distance_text)) }
    }
}
