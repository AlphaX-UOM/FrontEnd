...
function DisplayRatings(props) {
    ...
    useEffect(() => {
        fetch(
            `https://alphax-api.azurewebsites.net/api/hotelsserviceratings` //`https://alphax-api.azurewebsites.net/api/eventplannerservicereservations/${userId}`
        )
            ...
            .then((responseData) => {
                ...
                responseData = responseData.filter(item => item.hotelsServiceID === props.id);
