...
import "./HotelComments.css";
import Rating from "@material-ui/lab/Rating";
import TextField from "@material-ui/core/TextField";
import Box from "@material-ui/core/Box";
import Comment from "./HotelOneComments";
...
const HotelComments = (props) => {
    ...
    const handleFormData = () => {
        ...
        axios
            .post(
                "https://alphax-api.azurewebsites.net/api/hotelsservicecomments",
                commentObject
            )
    ...
    const handleInputRating = (event) => {
        ...
        var data = JSON.stringify({ "id": ratingApi.id, "rating": value, "userID": ratingApi.userID, "hotelsServiceID": ratingApi.hotelsServiceID });

        var config = {
            method: 'put',
            url: `https://alphax-api.azurewebsites.net/api/hotelsserviceratings/${ratingApi.id}`,
            headers: {
    ...
    const handleInputRatingPost = (event) => {
        ...
        var data = JSON.stringify({ "id": ratingApi.id, "rating": value, "userID": props.userid, "hotelsServiceID": props.add_id });

        var config = {
            method: 'post',
            url: `https://alphax-api.azurewebsites.net/api/hotelsserviceratings/`,
            headers: {
                'Content-Type': 'application/json',
    ...
    const commentListComponent = () => {
        ...
        console.log(commentList.hotelsServiceComments);
        console.log("data=> " + roomlist)

        return commentList.hotelsServiceComments.map((commentListObject) => {
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-9">
                                    ...
                                    {/* {rating=== 1?  <Rating name="pristine" value={ratingApi.rating} 
                                    onChange={handleInputRating}/>:"hii"}*/}
