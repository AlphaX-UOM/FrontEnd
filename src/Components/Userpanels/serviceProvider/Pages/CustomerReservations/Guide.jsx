...
function Guide(props) {
  ...
  const cancelHandler = () => {
    ...
    const fireGuide = {
      ...
      serId: canData.tourGuideService.userID,
      serName: canData.tourGuideService.name,
    ...
    <div>
      <TableContainer component={Paper}>
        <Table className={classes.table} aria-label="customized table">
          ...
          <TableBody>
            {eventList.map((row) => (
              <StyledTableRow key={row.tourGuideService.id}>
                <StyledTableCell component="th" scope="row">
                  {row.tourGuideService.name}
                </StyledTableCell>
                <StyledTableCell align="right">
                  {row.tourGuideService.language}
                </StyledTableCell>
                <StyledTableCell align="right">{row.checkIn}</StyledTableCell>
                <StyledTableCell align="right">
                  {row.tourGuideService.costPerDay}$
                </StyledTableCell>
                <StyledTableCell align="right">
                  <Button
                    variant="contained"
