...
import {InputLabel} from '@material-ui/core/';
  ...
  function EventTotal(props)  {
   ...
   let userID=props.userCred.id;
      ...
      .get(`https://alphax-api.azurewebsites.net/api/eventplannerservicereservations/Customers?serid=${userID}`)
      /*  .then((response) => {
   ...
   //  if(responseData.data.userID===userID)
      ...
      return (
        <div>
        <InputLabel>   <h4> Total Event Reservations</h4></InputLabel>
    ...
    export default connect(mapStateToProps)(EventTotal);
