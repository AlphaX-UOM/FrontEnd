...
import { Hotel } from '@material-ui/icons';
  ...
  function GuideTotal(props)  {
   ...
   let userID=props.userCred.id;
      ...
      .get(`https://alphax-api.azurewebsites.net/api/tourguideservicereservations/Customers?serid=${userID}`)
      /*  .then((response) => {
   ...
   //  if(responseData.data.userID===userID)
      ...
      return (
        <div>
        <InputLabel>   <h4> Total Guide Reservations</h4></InputLabel>
    ...
    export default connect(mapStateToProps)(GuideTotal);
