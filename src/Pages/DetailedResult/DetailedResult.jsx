...
function DetailedResultPage(props) {
  ...
  useEffect(() => {
    fetch(
      `https://alphax-api.azurewebsites.net/api/transportproviders/${tranId}`
    )
      .then((response) => {
  ...
  useEffect(() => {
    fetch(`https://alphax-api.azurewebsites.net/api/tourguides/${guideId}`)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
  ...
  useEffect(() => {
    fetch(`https://alphax-api.azurewebsites.net/api/eventplanners/${event01Id}`)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
  ...
  useEffect(() => {
    fetch(`https://alphax-api.azurewebsites.net/api/eventplanners/${event02Id}`)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
  ...
  useEffect(() => {
    fetch(`https://alphax-api.azurewebsites.net/api/hotels/${hotelId}`)
      .then((response) => {
        return response.json();
      })
      .then((responseData) => {
  ...
  let reservations = [
    {
      ...
      units: 1,
      unitTotal: 1* mytransportList.costPerDistance
    },
    {
      id: guideId,
    ...
    },
    {
      ...
      price: myhotelList.price * props.formdata.days,
      units: props.formdata.travelers,
      unitTotal: myhotelList.price * props.formdata.days * props.formdata.travelers
    }
  ];
